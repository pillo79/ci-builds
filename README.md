...
snippets/
  {owner}/
    {repo}/
      {branch}/
        metadata/
          *.json        ← per-build metadata (un-versioned; one file per metadata/ key)
        {version}/
          platforms/
            ...
            await github.rest.actions.createWorkflowDispatch({
              ...
              inputs: {
                ...
                snippets: JSON.stringify({
                  ...
                  // platforms/ and tools/ are stored under {branch}/{version}/
                  // metadata/ is stored directly under {branch}/ (un-versioned)
